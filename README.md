...
EMAIL_OAUTH_TOKEN_ENCRYPTION_KEY=<long random secret>
GOOGLE_CLIENT_ID=<google oauth client id>
GOOGLE_CLIENT_SECRET=<google oauth client secret>
GOOGLE_REDIRECT_URI=https://<project-id>.web.app/auth/google/callback
MICROSOFT_CLIENT_ID=<microsoft application client id>
MICROSOFT_CLIENT_SECRET=<microsoft application client secret value>
MICROSOFT_TENANT_ID=common
MICROSOFT_REDIRECT_URI=https://<project-id>.web.app/auth/microsoft/callback
